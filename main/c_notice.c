...
static const char *TAG = "OFFLINE_NOTICE";
...
void offline_notice(char index)
{
    ...
    sdcard_scan(sdcard_url_save_cb, "/sdcard/alarm", 0, (const char *[]) {"mp3"}, 1, sdcard_list_handle);
    ...
    */
    ...
    ESP_LOGW(TAG, "[ 6 ] Run audio pipeline");
