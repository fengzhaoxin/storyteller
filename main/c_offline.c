...
static const char *TAG = "SDCARD_OFFLINE_CONTROL";

EXT_RAM_ATTR static audio_pipeline_handle_t pipeline;
EXT_RAM_ATTR static audio_element_handle_t i2s_stream_writer, mp3_decoder, fatfs_stream_reader, rsp_handle;
EXT_RAM_ATTR static playlist_operator_handle_t sdcard_list_handle = NULL;
    ...
    if (evt->type == INPUT_KEY_SERVICE_ACTION_CLICK_RELEASE) {
        ...
        switch ((int)evt->data) {
            ...
            case INPUT_KEY_USER_ID_PLAY:
                ...
                ESP_LOGI(TAG, "[ * ] Stopped, advancing to the pervious song");
...
void offline_control(void *args)
{
    ...
    sdcard_scan(sdcard_url_save_cb, "/sdcard/play", 0, (const char *[]) {"mp3"}, 1, sdcard_list_handle);
    ...
    */
    ...
    EventBits_t bits=xEventGroupGetBits(offline_event_group);
    while (bits&OFFLINE_RUN_BIT) {
        ...
        */
        ...
        bits=xEventGroupGetBits(offline_event_group);
    }
